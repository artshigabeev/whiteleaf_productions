<section class="view-detail-item ">
    <?php
        ...
        ?>
    <div class="fl-title ">
        <div class="fl-title-small2"><?php the_category( ', ' ); ?></div>
        <div class="fl-title-medium ftm2"><?php the_title()?></div>
    </div>
    <div class="container">
        <div class="row">
...
<section class="detail-item detail-video-post">
    <div class="container">
        <div class="row">
                ...
                <div class="filmmaker-about-author">
                    ...
                    <div class="about-post-author col-md-10 col-sm-10 col-xs-9">
                        <span class="author-name">
                            <a href="<?php the_author_meta('url'); ?>" title="<?php the_author(); ?>"><?php the_author(); ?>
                        </a></span>
                        <p><span class="author-desc"><?php the_author_meta('description'); if(!get_the_author_meta('description')) esc_html_e('No description. Please update your profile.','filmmaker'); ?>
                        </span></p>
            ...
            <div class="col-lg-4 col-md-4 hidden-sm hidden-xs left-sidebar" >
                <?php $orig_post = $post;
                    global $post;
                    ...
                    <ul class="relate-post">
                        ...
                        <li>
                            <?php if (has_post_thumbnail()) { ?>
                                <div class="<?php printf('%s', $video_thumb);?> img-post col-lg-6 col-md-6 col-sm-12">
