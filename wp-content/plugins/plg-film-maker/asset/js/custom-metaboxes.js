jQuery(document).ready(function ($) {
	 ...
	 */
     //check show read more

	//  //Check show Properties when click
	$('#image_metabox, #video_metabox, #audio_metabox, #quote_metabox, #link_metabox, #gallery_metabox').hide('fast');
	...
	$('#post-formats-select input').click(function(){
		...
		$('#image_metabox, #video_metabox, #audio_metabox, #quote_metabox, #link_metabox, #gallery_metabox').hide('slow');
